...
function App() {
  ...
  return (
    <div className={`App ${open ? "app-fix" : ""}`}>
      ...
      <div className={`${open ? "block duration-300" : "hidden duration-300"}`}>
      ...
      <div className="flex justify-center items-center pt-52 pb-80" id="home">
        <div className="w-full h-auto md:w-4/5">
          ...
          <div className="flex flex-col justify-center items-center pt-9">
            ...
            >
              Web Developer. Googler. Content Creator. Mommy Boy. Blink. Member
              of Darkside.
            </motion.p>
            <motion.div
              className="mt-20"
          ...
          <div className="flex flex-col justify-center items-center md:flex-row">
            <div className="flex flex-col justify-center items-center lg:justify-start lg:items-start">
              ...
              <p className="font-secondry text-white pt-5 pb-5 md:text-lg">
                ...
                sector.<br></br>
                <br></br> So, here we are in 2022, and I am constantly studying
                and applying to all jobs at the junior level. So, if you require
                a developer for your project, please contact me. I would be
                delighted to assist you since it would allow me to improve my
        ...
        >
          <div className="flex flex-col justify-center items-center md:flex-row md:justify-start">
            <div className="flex flex-col justify-center items-center md:w-3/5 lg:justify-start lg:items-start ">
              ...
              <p className="font-secondry text-white pt-5 pb-5 md:text-lg">
                Nothing! , Just copy , paste and design profitable and beautiful
                websites with the finest user experience and a clean style. I
                developed progressively and using best practices. My main area
                of experience right now is front-end web development with React
                JS, customized animation, and design.
              </p>
            ...
            >
              ...
              <div className="flex flex-col justify-start mt-5 lg:justify-end lg:items-end">
                ...
                <p className="font-secondry text-white pt-5 pb-5 lg:bg-textbg lg:pl-7 lg:pr-7 lg:-ml-28 lg:text-navtextcolor lg:text-lg lg:rounded lg:shadow-md lg:mt-5 lg:mb-5 lg:z-30 ">
                  ...
                  save your item price, data, and calculate the final price in a
                  database. It includes a chud login API and the ability to
        ...
        <div className="w-11/12 h-auto md:w-2/3">
          ...
          >
            ...
            <p className="font-secondry text-white pt-5 md:text-lg">
              ...
              open. If you have a question or just want to say hi, feel free to
              contact me.
            </p>
            <div className="w-3/4 h-auto flex flex-col justify-start pt-7">
              ...
              <p className="font-secondry text-white mt-2">
                <span className="text-blueEdit">Phone</span> - +65 09-971569482
              </p>
            </div>
